...
public class ElfStarHuffmanCompressor32 implements ICompressor32 {
    ...
    public ElfStarHuffmanCompressor32(IXORCompressor32 xorCompressor, int window) {
    ...
    public ElfStarHuffmanCompressor32(IXORCompressor32 xorCompressor) {
        this.xorCompressor = xorCompressor;
        this.os = xorCompressor.getOutputStream();
