...
public class OutputBitStream implements Flushable, Closeable {
    ...
    static {
        ...
        try {
            org.urbcomp.startdb.selfstar.utils.InputBitStream.fillArrayFromResource("gamma.out.12", GAMMA);
            org.urbcomp.startdb.selfstar.utils.InputBitStream.fillArrayFromResource("delta.out.12", DELTA);
            org.urbcomp.startdb.selfstar.utils.InputBitStream.fillArrayFromResource("zeta3.out.12", ZETA_3);
            org.urbcomp.startdb.selfstar.utils.InputBitStream.fillArrayFromResource("shiftedgamma.out.12", SHIFTED_GAMMA);
     ...
     */
    public void copyFrom(final org.urbcomp.startdb.selfstar.utils.InputBitStream ibs, long length) throws IOException {
